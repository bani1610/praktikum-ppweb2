  ...
  <div class="w-[70%] mx-auto py-10">
    ...
    <div class="flex justify-between items-center mb-5">
        ...
        <form action="{{ route('logout') }}" method="POST" style="display: inline;">
            @csrf
            <button type="submit" class="bg-red-500 text-white px-4 py-4 py-1 rounded hover:bg-red-600">Logout</button>
        </form>
    </div>
    <!-- Textarea and Button -->
    @if(session('success'))
    ...
    <div class="space-y-6">
      ...
      <div class="bg-white p-5 rounded-xl shadow">
        ...
        <div class="text-sm text-gray-400 mt-2">Posted By: {{$post->user->name}}, On {{$post->created_at}}</div>
